from student_datamodule import StudentDataModule
...
student = StudentLightningModule(config,args.device,target_dim=36,seq_len=36)
...
checkpoint_callback = ModelCheckpoint(
    ...
    filename='onestep-random-{epoch:02d}-{val_loss:.2f}',  # 文件命名规则
    save_top_k=1,          

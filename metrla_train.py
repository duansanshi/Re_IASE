from metrla_datamodule import MetrlaDataModule
...
student = MetrlaLightningModule(config,args.device,target_dim=207,seq_len=24)
dm = MetrlaDataModule()
...
checkpoint_callback = ModelCheckpoint(
    ...
    filename='onestep-metrla-random-{epoch:02d}-{val_loss:.2f}',  # 文件命名规则
    save_top_k=1,          

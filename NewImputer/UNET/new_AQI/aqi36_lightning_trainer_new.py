...
train_flag = True
Decay = False
loss_flag = "midSupervision" # "l1" or "threshold" or "midSupervision"
device_num = 3
epochs = 200
...
if train_flag:
    ...
    aqi36_imputer = aqi_lightning_module.load_from_checkpoint(checkpoint_path="/home/duanlei/PriSTI/checkpoints/myimputer_aqi36/best_model-v69.ckpt",model=model,lr=1e-4)
...
checkpoint_callback = ModelCheckpoint(
    monitor="val_loss",
    dirpath="checkpoints/myimputer_aqi36",
    filename="best_model",
    save_top_k=1,
    save_last = True,
    mode="min",

"""
v6 Trainer: 方案A - 频率辅助输入（通道拼接）
"""
from aqi36_lightning_datamodule import AQI36_DataModule
from imputer_lightning_module_v6 import aqi_lightning_module
...
if args.exp_name:
    ...
    exp_name = f"v6_auxfreq{args.aux_freq_ratio}_c{args.curriculum_weight}_s{args.smooth_weight}"

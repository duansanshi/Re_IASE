...
parser.add_argument("--limit_train_batches", type=int, default=780)
...
pems08_dm = Pems08_DataModule(preimpute_flag=args.preimpute, freq_flag=not args.no_freq)
model = transformer_imputer(device=device)

if args.exp_name:
    exp_name = args.exp_name
else:
    exp_name = f"pems08_v5_t{args.curriculum_temperature}_c{args.curriculum_weight}"

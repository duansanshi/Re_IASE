...
aqi36_dm = AQI36_DataModule(device=device, preimpute_flag=args.preimpute, freq_flag=not args.no_freq, freq_ratio=args.freq_ratio, mavg_window=args.mavg_window, decay_alpha=args.decay_alpha, dct_ratio=args.dct_ratio, wavelet_level=args.wavelet_level)
model = transformer_imputer(device=device)

if args.exp_name:
    exp_name = args.exp_name
else:
    exp_name = f"v5_soft_t{args.curriculum_temperature}_c{args.curriculum_weight}_s{args.smooth_weight}"

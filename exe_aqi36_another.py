...
from dataset_aqi36_another import get_dataloader
from main_model_another import PriSTI_aqi36
...
def main(args):
    ...
    #model.load_state_dict(torch.load("/home/duanlei/PriSTI/save/pm25_outsample_20240730_031418/tmp_model194.pth", map_location=args.device))
